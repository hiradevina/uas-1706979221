...
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_init(JNIEnv * env , jobject obj ) ;
JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_resize(JNIEnv * env , jobject obj, jint
width , jint height ) ;
JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_step(JNIEnv * env , jobject obj ) ;
};
...
JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_init(JNIEnv
* env,
jobject obj
) {
if (g_renderer) {
...
JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_resize(JNIEnv
* env,
jobject obj, jint
width,
jint height
...
JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_hira_youngsil_ui_splash_GLES3JNILib_step(JNIEnv
* env,
jobject obj
) {
if (g_renderer) {
